...
$tx_eannuaires_domain_model_pack = array(
	'ctrl' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_eannuaires_domain_model_pack.pid=###CURRENT_PID### AND tx_eannuaires_domain_model_pack.sys_language_uid IN (-1,0)',
			),
		),
		...
		'title' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:e_annuaires/Resources/Private/Language/locallang_db.xlf:tx_eannuaires_domain_model_pack.title',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
...
return $tx_eannuaires_domain_model_pack;
?>