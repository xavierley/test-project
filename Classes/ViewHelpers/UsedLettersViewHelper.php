...
class UsedLettersViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper{
	...
	*/
     ...
     */
    public function render($list, $complete = 0){   
        ...
        if($list){   
            foreach($list as $fiche){   
                ...
                if(!in_array($firstLetter,$result)){
                    $result[] = $firstLetter;
                }
            }
        }
